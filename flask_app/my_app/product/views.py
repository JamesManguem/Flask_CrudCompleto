#desde my_app se importa la variable app que creamos anteriormente para usar el route y views
#from my_app import
#abort sirve para trabajar con peticiones HTTP
from flask import Blueprint,render_template,abort,request,redirect,url_for,flash,get_flashed_messages
#kit para trabajar con rutas http
...
#product es la clase que creamos en el modelo products
